    ...
    var body: some View {
        ScrollView {
            ...
            VStack(alignment: .leading) {
                ...
                Link("Pickle Documentation", destination: URL(string: "https://docs.python.org/3/library/pickle.html")!)
                Link("Download Python", destination: URL(string: "https://www.python.org/downloads/")!)
                Link("Pickle Usage Examples", destination: URL(string: "https://realpython.com/python-pickle-module/")!)
            }
            .padding()
        }
        .frame(width: 600, height: 500) // Lock Help Window Size
        .navigationTitle("Pickles Help Guide for macOS")
    }

    let helpGuideContent = """
